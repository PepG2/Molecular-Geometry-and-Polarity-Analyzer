...
By Ethan Chen
  ...
  VSEPR theory shows how electrons arrange themselves in bonds and lone pairs in order tostay as far away from other electrons as possible. Using this we were able to define a 
